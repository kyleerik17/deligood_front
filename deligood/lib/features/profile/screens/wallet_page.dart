...
class _WalletPageState extends State<WalletPage> {
  ...
  Future<void> fetchWallet() async {
    ...
    try {
      final data = await ApiService.get('/api/finance/wallet/');
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: loading
          ...
          : errorMessage != null
          ? _WalletError(message: errorMessage!, onRetry: fetchWallet)
          : CustomScrollView(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(colors: [kOrange, kTeal]),
        boxShadow: [
          BoxShadow(
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: (isCredit ? kTeal : Colors.red).withOpacity(0.1),
