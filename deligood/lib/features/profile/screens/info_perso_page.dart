        ...
        child: Stack(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                border: Border.all(color: kOrange.withOpacity(0.3), width: 3),
              ),
            ),
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          labelText: label,
          labelStyle: GoogleFonts.poppins(fontSize: 11.sp, color: kSubText),
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Icon(Icons.chevron_right, color: kSubText),
                ],
              ),
            ),
          ),
