...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _autoLogin() async {
    ...
    print("Auto-login check -> token: $token, userType: $userType");
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print("Erreur login: ${data['message']}");
      }
    } catch (e) {
  ...
  Future<void> _saveUserData(Map<String, dynamic> data) async {
    ...
    print("Sauvegarde token: $token, user: $user");
  ...
  Route _createRoute(String userType) {
    print("Navigation vers HomeScreen pour userType: $userType");
