...
class CoursePage extends StatefulWidget {
  ...
  const CoursePage({super.key, this.onCourseSelected});
...
class _CoursePageState extends State<CoursePage> {
  ...
  Uri.parse('${ApiConfig.baseUrl}/api/orders/livreur/available/'),
  headers: {
        ...
        Padding(
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
             ...
             final url = Uri.parse(
  '${ApiConfig.baseUrl}/api/orders/livreur/${selectedCourse!.id}/pickup/',
);
                ...
                try {
                  ...
                  if (response.statusCode == 200) {
                    // 🔹 Notifier le parent
                    widget.onCourseSelected?.call(selectedCourse!);
